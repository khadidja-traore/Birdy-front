...
class MainPage extends React.Component {
    ...
    setProfile = () => {
        this.setState({ isConnected: true, page_courante: "profilepage" });
    }

    setLogout = () => {
        this.setState({ isConnected: false, page_courante: "login" })
    }
